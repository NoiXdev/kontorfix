...
return [
    ...
    */
    ...
    | components and which file extensions to consider. Note that this
    | application lowercases the directory: `resources/js/pages`.
    |
    */
    ...
    */
    ...
    | read it back over HTTP. Left unset, recording is limited to the `local`
    | environment. Spelled out here rather than inherited from the package
    | default, because it writes request and response data to disk.
    |
    */
