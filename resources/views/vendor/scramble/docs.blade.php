...
<head>
    ...
    {{-- Published from vendor/dedoc/scramble so the renderer is served from this origin
         instead of unpkg.com, and so the inline blocks below can carry the CSP nonce.
         When Scramble is upgraded, diff its docs.blade.php against this copy. --}}
    @vite('resources/js/api-docs.ts')
    ...
    <style nonce="{{ \Illuminate\Support\Facades\Vite::cspNonce() }}">
        ...
        /* Moved off the <body> element's style attribute: a style ATTRIBUTE cannot carry a
           nonce, so leaving it there would have forced 'unsafe-inline' back into style-src. */
