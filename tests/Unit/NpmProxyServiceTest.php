...
it('rewrites tarball urls and caches the raw packument', function () {
    ...
    $doc = app(NpmProxyService::class)->packument($group, $up, 'left-pad', 'https://registry.test');
    ...
    Http::fake();
    app(NpmProxyService::class)->packument($group, $up, 'left-pad', 'https://registry.test');
